...
import { CheckCircle, ArrowRight, Users, BarChart3, Zap, Settings } from "lucide-react";
...
const MediaEmpresa = () => {
  ...
  return (
    <Layout>
      <SEO titleKey="seo.mediumBusiness.title" descriptionKey="seo.mediumBusiness.description" noIndex />
      {/* Hero Section */}
