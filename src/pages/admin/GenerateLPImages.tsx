...
const DEFAULT_PROMPTS: Record<string, string> = {
  ...
  solution: "A beautiful female AI virtual receptionist named Bia working in a modern phone control room. She is clearly an artificial intelligence - a sophisticated android with smooth synthetic skin with subtle purple LED accents on temples and neck, elegant metallic silver highlights on cheekbones and jawline, warm friendly expression with luminous eyes that show intelligence, wearing a professional white blouse. Not too futuristic or scary - beautiful, elegant and approachable. She sits at a curved control station with multiple holographic screens showing incoming calls and messages, calendar integration display with appointments, chat message bubbles floating around, purple ambient lighting matching brand color. The room has a modern call center aesthetic with subtle tech elements. Clean background without any logos or text overlays. Photorealistic quality with soft lighting. Ultra high resolution. 16:9 aspect ratio.",
